...
public class MikuInventoryContainer extends Container {
    private final ItemStack stack;
    private final Set<Slot> dragSlots = Sets.newHashSet();
    public IMikuInfinityInventory inventory;
    private EntityPlayer player;
    private int slotIndex;
    private int dragMode = -1;
    private int dragEvent;

    public MikuInventoryContainer(EntityPlayer player, ItemStack stack, int slotIndex) {
        if (!stack.isEmpty() && stack.getItem() instanceof MikuItem && (slotIndex == -1 && stack == player.getHeldItemOffhand() || slotIndex != -1 && stack == player.getHeldItemMainhand())) {
            this.stack = stack;
            this.inventory = ((MikuItem) stack.getItem()).getInventory(stack);
    ...
    public ItemStack slotClick(int slotId, int dragType, @Nonnull ClickType clickTypeIn, @Nonnull EntityPlayer player) {
        ...
        if (clickTypeIn == ClickType.QUICK_CRAFT) {
            ...
            if ((j1 != 1 || this.dragEvent != 2) && j1 != this.dragEvent) {
                ...
                if (slot7 != null && CanAddItemToSlot(slot7, itemstack12) && slot7.isItemValid(itemstack12) && (this.dragMode == 2 || itemstack12.getCount() > this.dragSlots.size()) && this.canDragIntoSlot(slot7)) {
                ...
                if (!this.dragSlots.isEmpty()) {
                    ...
                    for (Slot slot8 : this.dragSlots) {
                        ...
                        if (slot8 != null && CanAddItemToSlot(slot8, itemstack13) && slot8.isItemValid(itemstack13) && (this.dragMode == 2 || itemstack13.getCount() >= this.dragSlots.size()) && this.canDragIntoSlot(slot8)) {
    ...
    @Override
    @Nonnull
    public ItemStack transferStackInSlot(@Nullable EntityPlayer playerIn, int index) {
