...
public class MikuGenCaves extends MapGenBase {
    ...
    protected void addTunnel(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_) {
        ...
        for (boolean flag = random.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
            double d2 = 1.5 + (double) (MathHelper.sin((float) p_180702_15_ * 3.1415927F / (float) p_180702_16_) * p_180702_12_);
                    ...
                    for (int j1 = k2; !flag3 && j1 < k; ++j1) {
                        for (j3 = i3; !flag3 && j3 < i1; ++j3) {
                            for (int l1 = l + 1; !flag3 && l1 >= l2 - 1; --l1) {
                                if (l1 >= 0 && l1 < 256) {
                                    if (this.isOceanBlock(p_180702_5_, j1, l1, j3)) {
                                        flag3 = true;
                                    }
    ...
    protected boolean canReplaceBlock(IBlockState p_175793_1_, IBlockState p_175793_2_) {
        if (p_175793_1_.getBlock() == BlockLoader.MikuStone) {
            return true;
        } else if (p_175793_1_.getBlock() == BlockLoader.MikuDirt) {
            return true;
        } else if (p_175793_1_.getBlock() == BlockLoader.MikuGrass) {
            return true;
    ...
    protected boolean isOceanBlock(ChunkPrimer data, int x, int y, int z) {
    ...
    private boolean isTopBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ) {
        ...
        return this.isExceptionBiome(biome) ? state.getBlock() == Blocks.GRASS : state.getBlock().getDefaultState() == biome.topBlock;
    }
